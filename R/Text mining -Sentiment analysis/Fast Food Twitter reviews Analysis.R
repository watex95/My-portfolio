...
consumer_key<-'gzjLGTmXINi9dI2cW4tGxClV4'
consumer_secret<-'70UXE9lbG9JvUY4oMWwtDq5Zz9TdkL45kUj5CKrhctKeMcBlFS'

access_token<- '2758475550-y74EFyXu3F6AZF95Irw5y1TpSqVCBJYBXbEUQJp'
access_secret<-'l6YI9yPkdgwrLmNeNo2nY3R1jvmAuVhAa4QToehRU7RuH'


setup_twitter_oauth(consumer_key, consumer_secret,
      access_token=access_token, access_secret=access_secret)

McDonald<- twitteR::searchTwitter('#McDonald', n = 1000, lang = 'en', since = '2019-06-01', retryOnRateLimit = 1e3)
